import { CreateMetadataForestSchema, CreateMetadataSchema, CreateMetadataSubtreeSchema, CreateMetadataTreeSchema, CreateSnippetSchema, DeleteMetadataSchema, DeleteSnippetsSchema, GetMetadataForestSchema, GetMetadataSiblingsSchema, GetMetadataTreeSchema, SearchSnippetByNameSchema, UpdateSnippetContentSchema } from "./schemas.js";
...
export const createServer = (db) => {
    ...
    server.setRequestHandler(ListToolsRequestSchema, async () => {
        const tools = [
            ...
            { name: ToolName.CREATE_METADATA, description: "Create a metadata", inputSchema: zodToJsonSchema(CreateMetadataSchema) },
            { name: ToolName.CREATE_SNIPPET, description: "Create a snippet with metadata. All metadata have the same category", inputSchema: zodToJsonSchema(CreateSnippetSchema) },
            { name: ToolName.GET_ALL_SNIPPETS, description: "Get all snippets", inputSchema: zodToJsonSchema(z.object({})) },
            { name: ToolName.GET_ALL_METADATA, description: "Get all metadata", inputSchema: zodToJsonSchema(z.object({})) },
            { name: ToolName.DELETE_METADATA, description: "Delete metadata", inputSchema: zodToJsonSchema(DeleteMetadataSchema) },
            { name: ToolName.DELETE_SNIPPETS, description: "Delete snippets", inputSchema: zodToJsonSchema(DeleteSnippetsSchema) },
            { name: ToolName.UPDATE_SNIPPET_CONTENT, description: "Update snippet content", inputSchema: zodToJsonSchema(UpdateSnippetContentSchema) },
            ...
            { name: ToolName.CREATE_METADATA_SUBTREE, description: "Create a metadata tree from a given metadata root", inputSchema: zodToJsonSchema(CreateMetadataSubtreeSchema) },
            { name: ToolName.GET_METADATA_SIBLINGS, description: "Get siblings of a metadata", inputSchema: zodToJsonSchema(GetMetadataSiblingsSchema) },
