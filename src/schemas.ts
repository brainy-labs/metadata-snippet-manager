...
export type UpdateSnippetMetadataInput = z.infer<typeof UpdateSnippetMetadataSchema>;

export const GetSnippetsByDateSchema = z.object({
    date: z.date().optional(),
    operator: z.enum(['lte', 'gte', 'eq']).default('lte').describe(
        "Comparison operator: lte (<=), gte (>=), eq (=)"
    ),
